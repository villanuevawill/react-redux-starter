...
const CARD_ERROR = (
  <div>
    <p>
      No data can be loaded.<br /> Please refresh the page and try again.
    </p>
  </div>
);
...
const NOT_FOUND = (
  <div>
    <p>
      This page does not exist.<br />At least not in big deep data space.<br />(404 Error)
    </p>
  </div>
);
...
const TOP_LEVEL_ERROR = (
  <div>
    <p>
      Something went wrong in<br />deep big data space
    </p>
  </div>
);
